...
public class Quick3String {
    ...
    private static String printMatrix(int[][] dp) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 21; i++) {
            System.out.println(i + " => " + num2StrUnderThousand(i));
        } // END of for i
        ...
        for (int i = 10; i < 1000; i++) {
            ...
            System.out.println(i + " => " + num2StrUnderThousand(i));
            i = i + new Random().nextInt(333);
        } // END of for i
    }

    private static String num2StrUnderThousand(int number) {
        String temp = "";

        if (number % 100 < 20) {
            temp = LESS_THAN_20[number % 100];
        } // END of if
        else {
            temp = TENS[number % 100 / 10] + " " + LESS_THAN_20[number % 10];
        }
        ...
        return LESS_THAN_20[number / 100] + " Hundred " + temp;
